...
namespace HappyGardenConsoleVSU
{
    public class Spot
    {
        ...
        */
        ...
        {
            waterMM.Add(new Vector2(0, 0.3f));
            air.Add(new Vector2(0, 0.20f));
            smallLife.Add(new Vector2(0, 0.15f));
            humusQuality.Add(new Vector2(0, 0.6f));
            Nitrogen.Add(new Vector2(0, 0.05f));
            organicMatter.Add(new Vector2(0, 2f));

            Debug.Log("waterMM    " +waterMM[0]);
            Debug.Log("air    " + air[0]);
            Debug.Log("smallLife    " + smallLife[0]);
            Debug.Log("humusQuality    " + humusQuality[0]);
            Debug.Log("Nitrogen    " + Nitrogen[0]);
            Debug.Log("organicMatter    " + organicMatter[0]);
        }
        ...
        public void InitializeType(string jordType)
        {
            ...
            switch (jordType)
            {
                ...
                case "muldJord":
                    ...
                    //Debug.Log("Initialisering av jordverdier. Jordtype 'muldJord'");
                    topLayerSize = 5;
                    humusLayerSize = 30;
                    mineralEarthSize = 30;
                    water = 0.25;
                ...
                case "myrJord":
                    ...
                    //small life
                    bacteriaes = 500; //this means 1500 millions= 1 500 000 000
                    nematodesPredator = 5000;
                    springtales = 1000;
                    nematodesRootKnot = 0; //these parasitic may be implemented ater a later stage;
                    earthworms = 2;
                ...
                case "moreneJord":
                    ...
                    //initialization for the graph-values
                    waterMM.Add(new Vector2(0, 0.35f));
                ...
                case "default":
                    ...
                    waterMM.Add(new Vector2(0, 0.3f));
                    air.Add(new Vector2(0, 0.2f));
                    smallLife.Add(new Vector2(0, 0.1f));
                    humusQuality.Add(new Vector2(0, 0.25f));
                    Nitrogen.Add(new Vector2(0, 0.10f));
                    organicMatter.Add(new Vector2(0, 0.2f));

                    break;
            }
            //Debug.Log("initializeEarthType-funksjon. water=" + water);
        ...
        public void InitializeSpot()
        {
           ...
           /// water = 0.3; //tørt: 0-0.2, vått 0.3-0.6 f.x
            ...
            Debug.Log("waterOld="+waterold+"  ny verdi water er ..............................." + water);
            water_H2O = water;


            //Debug.Log("random: " + rnd.Next(1, 10));
            //Debug.Log("random: " + rnd.Next(1, 10));
            //Debug.Log("random: " + rnd.Next(1, 10));
            //Debug.Log("random: " + rnd.Next(1, 10));
            //Debug.Log("random: " + rnd.Next(1, 10));
     ...
     /*       ////Micro næringsstoffer
            min_Fe = Nyverdi(min_Fe , 1);

            min_Mn = Nyverdi(min_Mn , 1);
            min_Zn = Nyverdi(min_Zn , 1);
            min_B = NyverdiDecimal(min_B , 1);
                        //Debug.Log(" min_B=" + min_B); 
            min_Cu = Nyverdi(min_Cu , 3);
            min_Mo = Nyverdi(min_Mo , 3);
 */
            
/*
            Debug.Log("\nwater:       " + water_H2O);
            Debug.Log("nutr_C:      " + nutr_C);
            Debug.Log("nutr_O:      " + nutr_O);
            Debug.Log("nutr_H:      " + nutr_H);
            Debug.Log("nutr_N:      " + nutr_N);
            Debug.Log("nutr_K:      " + nutr_K);
            Debug.Log("nutr_Ca:     " + nutr_Ca);
            Debug.Log("nutr_Ph:     " + nutr_Ph);
*/
        ...
        public void WriteSpot(Text myText)
        {
            ...
            //Debug.Log("nutr_Ca:     " + nutr_Ca);
            //Debug.Log("nutr_Ph:     " + nutr_Ph);
            //Debug.Log("nutr_S:      " + nutr_S);
            //Debug.Log("nutr_Mg:     " + nutr_Mg);

            //Debug.Log("min_Fe:      " + min_Fe);
            //Debug.Log("min_Mn:      " + min_Mn);
            //Debug.Log("min_Zn:      " + min_Zn);
            //Debug.Log("min_B:       " + min_B);
            //Debug.Log("min_Cu:      " + min_Cu);
            //Debug.Log("min_Mo:      " + min_Mo);
        }
        ...
        public void Update(int iterasjon)
        {
            ...
            //Debug.Log("spot " + h_index + v_index + ":  this.Planted=" + plantet);

            //getting today's weather
            //Be mindful of: simulation iteratinos vs
            Weather vaer = Weather.ThisDay;
...
*/
                ...
                case 3:
                  ...
                  //  Debug.Log(ut0);
                    ...
                    ///double newwaterdrink = (newwaterdry - newwaterdry * dryout);

                    //Debug.Log("-----> uttørk faktor: " +  "  Water(" + water_H2O + ") - dryoutwater("+ dryout + ") = newwaterdry: " + newwaterdry);
                    //Debug.Log("-----> drikke faktor: " + "  Water(" + newwaterdry + ") - drinkwater(" + drinkwater + ") = newwaterdrink" + newwaterdrink);
                   // Debug.Log("-----> drikke faktor: " + "  Water(" + water_H2O + ") - drinkwater(" + basedrinkwater + ") * waterNeedSun("+waterNeedSun+") = newwaterdrink " + (water_H2O-drinkwater));
                    ...
                    //
                    // double faktor = (30.0 * 5) / 1000;
                    //// Debug.Log("(30 * 5) / 1000 " + faktor);
                    // Debug.Log("uttørk faktor(dummy): " + faktor );
                    ...
                    //Oppdaterer planten
                    //dette gjøres etter at verdiene er satt opp mot hverandre, og selve vekstparametrene bestem
                   ...
                   /* uttekst = myText;
                    ...
                    day = vaer.WhichDay;
                    String nytekst = String.Format("Day {10}   Water {0}, N {1}, C {2}, K {3}, Ca {4}, Ph {5}, X {6}, Y {7} Z {8}, Plant: {9}", water_H2O, nutr_N, nutr_C, nutr_K, nutr_Ca, nutr_Ph, nutr_S, nutr_Mg, min_Fe, plantName, day);
