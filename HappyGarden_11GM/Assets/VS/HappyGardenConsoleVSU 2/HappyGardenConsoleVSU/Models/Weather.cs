...
namespace HappyGardenConsoleVSU
{
    public class Weather {
        ...
        private List<Vector2> rain = new List<Vector2>();
        private List<Vector2> sun = new List<Vector2>();
        ...
        {
            int dag = dg;
            //Debug.Log("initialiserer Weather");
            ...
            else
            {
                ...
                rain.Add(new Vector2(dag, sunH[dag])); 
        ...
        public List<Vector2> Sun
        {
            get { return sun; }
            set { sun = value; }
        }

        public List<Vector2> Rain
        {
            get { return rain; }
            set { rain = value; }
        }
